...
| ---------------------------- | ------------------ | ------------------ | ----------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| Apple MacOS 11               | :heavy_check_mark: | :heavy_check_mark: |                                                                                           |                                                                                         |
| Apple MacOS 12               | :heavy_check_mark: | :heavy_check_mark: |                                                                                           |                                                                                         |
| Apple MacOS 13               | :heavy_check_mark: | :heavy_check_mark: |                                                                                           |                                                                                         |
...
| Microsoft Windows 2019 (WSL) | :heavy_check_mark: | :zzz:              |                                                                                           |                                                                                         |
| Microsoft Windows 2022 (WSL) | :heavy_check_mark: | :zzz:              |                                                                                           |                                                                                         |
...
**NOTE** Gitlab builds for the `master` branch run only once a week due to freemium limits.
