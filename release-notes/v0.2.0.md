# support-firecloud v0.2.0 Release Notes
...
* 46c7d3e 2020-01-16 optimize travis hack
...
| * ad7eaae 2020-01-14 extract start-docker-ci to a function
...
* aa4ac1d 2020-01-10 pass on custom travis env vars - set in the UI or .travis.yml
...
* | 602eecc 2019-12-30 add stub for slack notifications on ga (without slack integration)
...
* | c6ca006 2019-12-25 fixup! add github workflow stub
...
|\  
| * 6175029 2019-10-22 de-transcrypt also for PRs from the same repo. fix #131
...
* 19d967a 2019-09-04 breaking: rename js.common.node.mk to node.common.mk
...
* 5cb0ed3 2019-09-01 allow 'npm i -g npm' to fail on WSL. ref #126
...
* bda5915 2019-07-08 'npm list' doesn't close stdout...
...
|\ \ \  
| * | | 511f73c 2019-05-15 make it easy to clean cfn artifacts. ref #98
| |/ /  
...
|\ \  
| * | fce7dd9 2019-05-02 move IO outside func
...
* | 42e9475 2019-03-25 fix promote/env/tag target for first time deployment to an env
...
* | e41d46d 2019-02-08 use fd 3 to prevent stdin to be gulped (cont)
...
* 6e59684 2019-01-17 concise PR template
...
*   2fb1723 2019-01-10 Merge pull request #73 from tobiipro/f/anu-show-promotion-log
|\  
...
| * | | cf36472 2018-12-15 make Brewfile.inc.sh mandatory. fixes #54
...
* 51e7a85 2018-12-16 rename bin/exe-path.inc.sh to bin/exe-env.inc.sh
...
* 2172eab 2018-12-10 report not explicit babel-jest transformer
...
| * 659382d 2018-11-24 add future fixme note
...
* | 7b7ff25 2018-04-17 ci-echo: empty line before DO instead, helps with travis UI
...
* cba8381 2018-04-05 declare CI_ECHO only once
...
* 6dd2d82 2018-03-12 aws-cfn2dot is already an executable
* 65b83ec 2018-03-12 separate release per publish type
* a98c033 2018-03-12 safer curl
* e777ec7 2018-03-12 introduce SF_DEPS_TARGETS
* 7c49cd6 2018-03-12 check if SF_CLEAN_FILES is empty
* 0ba590f 2018-03-11 add sf_rvm_unfuck
* 1627e24 2018-03-11 try brew upgrade twice
* 36ca0bb 2018-03-11 handle no trailing newline in http response to curl
* 740c0df 2018-03-09 rename aws-iam-login -> aws-ian-login.inc.sh
* 9adfe06 2018-03-09 document <make release>
* 952d2c3 2018-03-09 upgrade default shell, if bash. fix #15
*   62ee88e 2018-03-09 Merge pull request #14 from tobiipro/f/anu-aws-iam
|\  
| * 4fbdc81 2018-03-09 aws-sdk-js should use AWS_PROFILE now https://docs.aws.amazon.com/sdk-for-javascript/v2/developer-guide/loading-node-credentials-shared.html
| * 570f841 2018-03-05 add aws-iam-bootstrap&co. fix #12
|/  
* 602bff6 2018-03-07 recommend to run a daily CI on master branch
* 58321cc 2018-03-07 deterministic: don't cache node_modules folder
* def1134 2018-03-07 add release targets for repo
* be85dc0 2018-03-07 deterministic: don't cache node_modules folder
* 12da39a 2018-03-07 logical flow would be to build&test -> tag -> publish
* 8cb7d5a 2018-03-07 clean up repo makefiles
* e509fb5 2018-03-07 make nuke not make clean
* 63f1a34 2018-03-07 don't eclint support-firecloud symlink
* 6497b08 2018-03-07 red or blue pill. that is the question
* 06d20ce 2018-03-07 style
* f260f12 2018-03-07 less quirks: prefer using files property in package.json
* 76e3bb6 2018-03-06 complete description for test target
* 871e5f8 2018-03-06 add target to update support-firecloud to latest master
* dd8d829 2018-03-06 jest: collect coverage in CI
* f79f13c 2018-03-06 red or blue pill. that is the question
* e506ff1 2018-03-05 rely only on npmrc for package-lock=false
* 6790734 2018-03-05 test decrypted only if repo is transcrypted
* 2b8117b 2018-03-05 copy and import jest.config.js instead of symlinking
* 0194ff6 2018-03-05 clarify sources of .npmignore
* e4b80c6 2018-03-05 add target to build.npmignore from global gitignore, local gitignore and npm exceptions
* 092b3de 2018-03-05 whitespace
* 08bf979 2018-03-05 gitignore template for node
* 4a7e978 2018-03-05 jest: stop coverage and notifications
* c5eaebd 2018-03-05 normalize var quoting, function keyword, etc
* b8e57bd 2018-03-05 remove teamcity utils
* f8c437e 2018-03-04 cleanup aws-iam-expand-user-policies
* bd1d736 2018-03-04 add missing deps
* 3d7ea58 2018-03-03 don't relly on bin/common.inc.sh to set strict-mode
* d4e7af8 2018-03-03 move GIT_BRANCH correction on travis from core.inc.mk
* 75624ef 2018-03-03 check if argument is empty before invoking commands
* 20b2c90 2018-03-03 fixup! make sure the required homebrew pkgs are installed with the required options. fix #13
* 6ec0e28 2018-03-03 make sure the required homebrew pkgs are installed with the required options. fix #13
* 22cc68c 2018-03-03 cleanup
* 9699a5c 2018-03-02 add link to BSD vs GNU differences :)
* 906ca29 2018-03-02 style
* d93d054 2018-03-02 add echo-section for 'make version'
* 6e539c7 2018-03-02 typo turning 'make version' into a noop
* 5f19b3c 2018-03-02 ci/dev bootstrapping is stable now, remove verbose flag
* 79f1f27 2018-03-02 python@2 is keg-only and needs link --force https://github.com/Homebrew/homebrew-core/issues/24189
* c402ace 2018-03-02 brew's default python became python3 https://github.com/Homebrew/homebrew-core/issues/24189
* ede19d6 2018-03-02 try to fix warning about mongodb pkgs cannot be authenticated
* 0f7e5af 2018-03-02 source common.inc.sh in .travis.sh
* af65841 2018-03-02 consistent file naming
* d159eab 2018-03-02 split repo/mk/js.common.node.mk info babel and webpack
* 69735ef 2018-03-01 travis-debug: automatically connect to the tmate session and delete the log
* ae7df26 2018-03-01 allow for a repo to be transcrypt-ed, but no TRANSCRYPT_PASSWORD given
* 81135e6 2018-03-01 don't ignore eslinting .babelrc.js
* 9ba09fa 2018-03-01 symlink jest.config.js
* b50cec9 2018-03-01 wording
* 511201a 2018-03-01 Replace == to =
* 3d7987c 2018-03-01 Another logic fix for SF_*_TARGETS
* 71113d1 2018-03-01 Probably, typo fix
* 01d4260 2018-03-01 fix incorrect check for empty SF_*_TARGETS
* 0c444a7 2018-03-01 fix typo for build target
* 9a13aa7 2018-03-01 redirect outside cmd
* 1f67625 2018-03-01 generic jsonlint based on stedolan/jq or trentm/json
* c3729a4 2018-03-01 more silent
* d56995e 2018-03-01 consistent brackets
* 839bf8e 2018-03-01 consistent brackets
* 8f1f33b 2018-03-01 add travis-debug script
* cbaeffb 2018-03-01 fixup! fix npm not found on sudo-linux
* b6acaa1 2018-03-01 fix npm not found on sudo-linux
* 1a92b17 2018-02-28 optimize running targets. no double check
* 8d6b765 2018-02-28 handle no SF_*_TARGETS
* 530bff0 2018-02-28 add missing lint-json target
* be5765d 2018-02-28 style
* 60b787c 2018-02-28 move package-lock.json to js.common.node
* 94139b2 2018-02-28 whitespace
* 5e4b782 2018-02-28 implement test targets. fix #7
* 3291b06 2018-02-28 fix path
*   a32dc48 2018-02-28 Merge pull request #10 from tobiipro/f/anu-node-bootstrap
|\  
| * 9dbae98 2018-02-28 cleanup repo bootstrap and travis config
| * 7d990d4 2018-02-28 refactor docs
| * 5698532 2018-02-28 typo
| * 67d94b7 2018-02-28 usage for .travis.sh
| * aaa6a3f 2018-02-28 sync repo-cfn-bootstrap with repo-node-bootstrap
| * 321dbc8 2018-02-28 add repo-node-bootstrap
| * 17e23e8 2018-02-28 redundant
|/  
* 6686a43 2018-02-28 Revert "use symlinks as if support-firecloud is a submodule"
*   cb70c48 2018-02-28 Merge pull request #9 from tobiipro/f/anu-refactor-travis-yml
|\  
| * e45354a 2018-02-28 remove tracks/teamcity
| * 2eb2a32 2018-02-28 use symlinks as if support-firecloud is a submodule - not for .travis.yml or else travis fails
| * bfbef71 2018-02-28 use symlinks as if support-firecloud is a submodule
| * 053d20f 2018-02-28 refactor .travis.yml
|/  
*   54ec226 2018-02-28 Merge pull request #8 from tobiipro/f/anu-github-get-asset
|\  
| * 8489467 2018-02-27 style
| * d71eb6f 2018-02-26 add github-get-asset bash helper
* | 35df412 2018-02-26 style
|/  
* 3d1c4db 2018-02-26 no warn about TRAVIS being undefined
* 93d389a 2018-02-26 fixup! add docs around releases
* 2b37fc0 2018-02-26 rename GIT_TAG -> GIT_TAGS
* 18296fa 2018-02-26 do not rely on TRAVIS_TAG
* 0dde9a1 2018-02-26 updated repo/mk/core.inc.mk
* c46f972 2018-02-26 add docs around releases
* 57bccea 2018-02-26 fix TRAVIS git info
* d421d97 2018-02-26 typo
* 2dfad3a 2018-02-26 updated repo/mk/core.inc.mk
* 70666bf 2018-02-25 typo
* 34fe49a 2018-02-25 updated repo/mk/core.inc.mk
* a8a93f3 2018-02-25 repo/core.inc.mk -> repo/mk/core.inc.mk
* fda2a73 2018-02-25 add GIT_REMOTE
* 4d3cad8 2018-02-25 updated repo/core.inc.mk
* 21ff9ca 2018-02-25 typo in aws-get-stack-output
* ef00a4a 2018-02-25 breaking: aws-get-stack-* have no positional arguments
* 441402f 2018-02-25 use true instead of :, for consistency and visibility
* 98ee319 2018-02-25 typo
* 192e066 2018-02-25 split target to create cfn diff
* 04342d0 2018-02-25 typo
* e4ee957 2018-02-25 don't fail if no eslint-config-firecloud or babel-preset-firecloud
* fe52357 2018-02-25 add Makefile
* 99e3062 2018-02-25 style. us ci-echo
* cf4ce1f 2018-02-24 support travis info
* 10f467c 2018-02-24 add travis settings
* 2fb61b6 2018-02-24 style
* a44e976 2018-02-24 add GIT_TAG
*   f83fdc9 2018-02-24 Merge pull request #5 from tobiipro/f/anu-working-with-github
|\  
| * d316dc7 2018-02-24 add docs/working-with-github.md
* |   6be944a 2018-02-24 Merge pull request #2 from tobiipro/f/anu-cfn-bootstrap
|\ \  
| * | 9a12313 2018-02-24 correct call to <aws cloudformation>
| * | e4fc8d8 2018-02-19 add linting rule
| * | b318c0e 2018-02-18 mark as executable
| * | 523e31a 2018-02-18 no real need for babel
| * | 9793179 2018-02-18 copy instead of symlink
| * | 40f218c 2018-02-18 generalize
| * | cf8e561 2018-02-18 Revert "AWS_ACCOUNT_ID is not needed"
| * | 1f0edbe 2018-02-18 fix undefined AWS
| * | 422336f 2018-02-18 add .gitignore template
| * | 35b9b7c 2018-02-18 no need to specify eslint config
| * | 6656e69 2018-02-18 rename repo/cfn/Makefile to repo/cfn/inc.mk for clarity
| * | 5ee2cf5 2018-02-18 SUPPORT_FIRECLOUD_DIR is set before the inclusion of this makefile
| * | d26a2a4 2018-02-18 use aws-util-firecloud
| * | d0a5aec 2018-02-17 redundant
| * | 7a282e3 2018-02-17 AWS_ACCOUNT_ID is not needed
| * | 3a0f2b5 2018-02-17 improve docs
| * | 9964b31 2018-02-17 generalize S3_INFRA_BUCKET
| * | 6c0497b 2018-02-17 refactor, reduce required vars
| * | 83f4b10 2018-02-17 note2self
| * | b95753a 2018-02-17 use JSON instead of JQ
| * | ac6c275 2018-02-17 generalize STACK_NAME
| * | c2f0a23 2018-02-17 CFN_DIR in root of repo
| * | c33aff8 2018-02-17 a python alternative to gnu's realpath --relative-to (recent addition)
| * | 63910fc 2018-02-16 document cfn bootstraping
* | | ee315c3 2018-02-24 fix installing latest npm&json
| |/  
|/|   
* | 9b7d13d 2018-02-22 fix wrong license mentioned in README.md
* | a1edb6f 2018-02-22 add description
* | d17b970 2018-02-22 always upgrade to latest npm
* | b077fae 2018-02-22 install latest nodejs even on linux
* |   7eca2aa 2018-02-21 Merge pull request #4 from tobiipro/f/anu-local-npm
|\ \  
| * | c6c3f4d 2018-02-21 add note about devDependencies
| * | 7860967 2018-02-21 updated docs/working-with-local-npm-dependency.md
|/ /  
* | 494cded 2018-02-21 switch to Apache 2.0 license, since there's actual code in the repo
* | 8d5ca2e 2018-02-21 Added .babelrc dependency for js build target
* | b5c86b4 2018-02-20 use ci-echo
* | 88ae5fa 2018-02-20 make sure there's a 'not found' string on failure
* | 5f30c5a 2018-02-20 add note about travis-encrypt not working for private repos
* | f7fad6e 2018-02-20 docs: less confirmations
* | 7cef673 2018-02-20 docs: remember to commit .gitattributes
* | ceb4c98 2018-02-19 Added pushInsteadOf for git://github.com
* | c52d68d 2018-02-19 Added .d.ts files makefile
|/  
* 1fc96d0 2018-02-18 updated repo/core.inc.mk
* 551cf01 2018-02-16 document TRAVIS_EVENT_TYPE
* d13c4d1 2018-02-16 use TRAVIS_EVENT_TYPE
* e769e69 2018-02-16 typo
* d3014af 2018-02-16 do not run checks on f/ branches
* a7c034b 2018-02-16 do not run decryption on pull requests
* b83696a 2018-02-16 follow standard
* 15a7aab 2018-02-16 fix SUPPORT_FIRECLOUD_DIR
* 26d7dd2 2018-02-16 publish target should not version under the hood
* cfae1b1 2018-02-16 typo
* 66399f3 2018-02-16 move test to package.json for transparency
* bd07c1b 2018-02-16 fix link to example travis.yml
* b6d8130 2018-02-15 Revert "tmpfix. see aws/aws-cli/issues/3149"
* 020eb43 2018-02-15 breaking: split out eslint targets
* e828858 2018-02-15 breaking: refactor repo makefiles
* 012c7f7 2018-02-15 add test with jest target
* 692d47a 2018-02-15 add target to publish to git tags
* a64b5b5 2018-02-15 breaking: split npm-publish-git target to its own makefile
* 1aa99c2 2018-02-15 tmpfix. see aws/aws-cli/issues/3149
* 02a2ee4 2018-02-15 use transcrypt template in gitattributes
* b909c7f 2018-02-14 allow JS_FILES to be ignored
* 288b447 2018-02-14 remove git alias.ls-crypt when flushing transcrypt credentials
* f24b697 2018-02-14 add note about uninstalling transcrypt when work is done
* 7da721c 2018-02-14 force remove .git/crypt when uninstalling transcrypt
*   e0df6ba 2018-02-14 Merge pull request #1 from tobiipro/anu-manage-secrets
|\  
| * 966ebeb 2018-02-13 added transcrypt recipients
| * 072d79b 2018-02-13 add transcypt symlink to increase consistency with docs
| * 23c904e 2018-02-13 instruct to copy latest transcrypt gpg export, not all
| * 9000e2a 2018-02-13 update example of gitattributes with an actual template
| * f408ab3 2018-02-13 use git config's travis.slug as the official client https://docs.travis-ci.com/user/encryption-keys/#Fetching-the-public-key-for-your-repository
| * 8a691b1 2018-02-13 link to .travis.yml as an example of decrypting the repo before_install on travis
| * 9bdc853 2018-02-13 not possible to have encrypted commands in travis?
| * 3bcc45c 2018-02-13 give travis access to transcrypt
| * 24ddba0 2018-02-13 add transcrypt test (content)
| * a9fc17d 2018-02-13 add transcrypt test
| * 54e3d26 2018-02-13 fix command to show transcrypt configuration
| * f1fdc7b 2018-02-13 add info on .gitattributes for transcrypt
| * d84c206 2018-02-13 use gnu sed in transcrypt
| * 869fa8f 2018-02-13 add links to travis ci docs around encryption
| * 1131e5b 2018-02-13 add manage-secret docs
| * e5e143c 2018-02-13 add working-with-gpg docs
| * 0462267 2018-02-13 add simplified travis-encrypt executable
| * 0490a85 2018-01-30 add original 1.0.3 transcrypt
| * a745342 2018-02-12 bug: remove git-crypt filters
* | bf72be3 2018-02-14 link to editor-setup.md
* | 7340a3a 2018-02-14 add editor-setup.md
* | 6135a7a 2018-02-14 Ignore backup files (tilde suffix)
|/  
* fc91d60 2018-02-13 eclint package.json
* dc1d2ab 2018-02-13 Revert "workaround for travis slack notification on success"
* 7ac087f 2018-02-13 workaround for travis slack notification on success
* d962172 2018-02-13 Revert "disable osx since the waiting time is big"
* 89954cc 2018-02-12 add fixme about ci/deps-os-* temporary executables
* b2a7d42 2018-02-12 use global gitattributes and gitignore from home folder
* cb0a029 2018-02-12 add note about symlinking ~/git/firecloud
* ce62688 2018-02-12 Revert "Fix for aws-get-cli-sts and ‘date’ on Mac + exit logic fix (replaced || -> &&)"
* ac17bcb 2018-02-12 Revert "Another fix for aws-get-cli-sts including timezone for date parsing"
* 986a208 2018-02-12 add gnu-time for osx
* 1101c40 2018-02-06 Another fix for aws-get-cli-sts including timezone for date parsing
* 0f48924 2018-02-05 Fix for aws-get-cli-sts and ‘date’ on Mac + exit logic fix (replaced || -> &&)
* 4fe6f74 2018-01-29 add default jest config
* 91900d6 2018-01-26 split README into docs
* 50785c7 2018-01-22 trying out slack notifications
* 70d90ad 2018-01-22 allow long lines in .travis.yml
* 3c9df53 2018-01-17 sort lines
* 44d4c2e 2018-01-17 lint
* 05c1d59 2018-01-16 safer version for listing submodules
* cc669aa 2018-01-16 ignore git submodules when eclint-ing
* 74e5f20 2018-01-16 ignore eclinting bin and package.json
* c7e4cc5 2017-12-22 aws-cli 1.14 now uses hashed credential caches
* 1a63d24 2017-12-13 use python2 specifically
* 5204db4 2017-11-15 DIR is undefined
* c497615 2017-11-15 updated bin/ci-echo
* cf88061 2017-11-15 updated bin/ci-echo
* 4de8d7c 2017-11-06 remove bin/aws-apigateway-cd-domain-name since it's not standalone
* c4bcf08 2017-10-27 style
* f70999d 2017-10-27 correct path to common.inc.sh
*   376a281 2017-10-27 Merge branch 'more-bins'
|\  
| * ce1dd67 2017-10-27 move aws-athena
| * 33708c7 2017-10-26 updated support/bin/.editorconfig
| * 1e60e80 2017-10-26 productify sake
| * be41e67 2017-10-26 sake helper
| * 5d47521 2017-10-26 rename cfviz -> aws-cfviz
| * 1a21f5e 2017-10-26 aws-athena: generic path
| * e203e94 2017-10-26 style
| * bb55853 2017-10-26 add license header for cfviz
| * eb2c1b9 2017-10-26 rename athena -> aws-athena, get-aws-cli-sts -> aws-get-cli-sts, cfn2dot -> aws-cfn2dot
| * 4d3b6d5 2017-09-14 cfn-util is now aws-cfn-util-firecloud
| * 06fb8c0 2017-09-13 split into modules, bulk minor fixes
| * d18d8d5 2017-07-21 GIT_SSH_COMMAND is now an env variable in TeamCity
| * 9b96e23 2017-05-22 add athena util (cont)
| * ffef64b 2017-05-22 add athena util
| * d41e569 2017-05-08 fix cloudformation script showing only old stack events, instead of new ones
| * cadf919 2017-04-20 Revert "fix cloudformation script showing only old stack events, instead of new ones"
| * 6f4a62c 2017-03-28 fix cloudformation script showing only old stack events, instead of new ones
| * 3f95f41 2017-02-26 sake 2.0 - find nearest Makefile and execute in that folder
| * 943904c 2017-02-21 remove support for cygwin
| * 8a806bd 2017-02-21 updated support/bin/aws-apigateway-cd-domain-name
| * 9e2c216 2017-01-23 case
| * a8097eb 2017-01-20 less noise in failure on aws-cloudformation-cu-stack
| * 810f959 2017-01-18 .get-aws-cli-sts fixes
| * efd6102 2017-01-16 fixup! add nodejs cfn2dot helper
| * bc5174d 2017-01-15 add nodejs cfn2dot helper
| * 36899ed 2017-01-15 [TFC-1161] export aws-cli assumed-role credentials to env for compat with aws-sdk-go, aws-sdk-js, etc
| * f72eb61 2017-01-12 add build-fixed slack notification; refactor slack calls
| * d4df646 2017-01-10 fixup! Use gnu utils on Mac.
| * 8e8cbe2 2017-01-10 Use gnu utils on Mac.
| * 9d30a7b 2017-01-10 fixup! fix slack-echo
| * ac70cf2 2017-01-09 fix slack-echo
| * a2eed04 2017-01-09 delete stack only on create failure, not update
| * 671bcf1 2017-01-09 [] fix help
| * fb25a08 2017-01-09 fix unbound variable
| * 1cbd1d4 2017-01-05 default slack notification to hooks' channel
| * 8374423 2017-01-05 update info about default slack channel
| * 74ca106 2017-01-04 sponge needs to keep ownership and permissions
| * f61c07e 2016-12-13 validate cfn template also with template-url
| * 9f04ce0 2016-12-13 always trap
| * ed55740 2016-12-05 cfnviz: rename to cfviz
| * f7389fb 2016-12-04 cfnviz: rank same
| * c0a9297 2016-12-04 cfnviz: add original from https://github.com/benbc/cloud-formation-viz/blob/2e4fbcce9863db458c4a1fe043aa2ad3200f8c19/cfviz
| * 5ff519c 2016-12-02 upgrade node, aws-cli, apex, npm
| * 6d6ac63 2016-11-11 try another trick to get git push to work
| * a1b47d5 2016-10-22 pour sake
| * 5c89d54 2016-10-13 mark change in slack webhook, switched to #cloud-team from #cloud
| * c16d3e8 2016-10-10 add patched apex for macos sierra
| * e6b7423 2016-10-07 [TFC-969] slack-echo needs to escape text
| * 6805c1c 2016-10-02 add aws-iam-expand-user-policies
| * 7ef36c7 2016-09-26 add some log
| * 491769e 2016-09-26 [TFC-941] remove Carl's certificate/key cleanup. not needed
| * 13afd97 2016-09-25 [TFC-941] use api gateway lambda proxy
| * 7deab81 2016-09-25 [TFC-935] use s3 for tmp cfn templates
| * f270552 2016-09-20 [TFC-837] todo
| * d268721 2016-09-06 simpler delete-stack script
| * bb71469 2016-09-06 check if the bucket exists at all, before trying to remove it
| * 2f1e50b 2016-09-06 more massaging of the delete-stack script
| * d21ee9d 2016-09-06 empty-s3
| * 0844098 2016-09-06 fix namings
| * 389ed3d 2016-09-06 fix aws-cloudformation-delete-stack
| * ba5c77b 2016-09-05 it mv support/bin/aws-d-stack support/bin/aws-cloudformation-delete-stack
| * a853d7e 2016-09-05 it mv support/bin/aws-cu-stack support/bin/aws-cloudformation-cu-stack
| * 45117f8 2016-09-05 better help for aws-cu-stack
| * 884833d 2016-09-05 add aws-d-stack to support/cfn
| * 37f2fbc 2016-08-11 trap cancel create stack
| * 4ab6da6 2016-08-10 aws-cu-stack on-failure support
| * 4ca8194 2016-08-10 remove comment code
| * 29e1963 2016-08-09 add progress url for aws-cu-stack
| * 3f5532c 2016-08-07 echo change set url
| * d7b4bd8 2016-08-07 trap interuption and cancel update stack
| * 86912c1 2016-08-07 try returning only new events
| * 75afa42 2016-08-07 cfn - all infra stack works ok
| * df81435 2016-08-07 updated support/bin/aws-cu-stack
| * 8ab2b2e 2016-08-07 aws-cu-stack
| * 12decac 2016-08-06 fix create/update mix
| * 8faafa2 2016-08-06 more logging in aws-cu-stack
| * 64d735d 2016-08-06 cfn
| * 5b684cc 2016-08-06 cfn
| * 756f162 2016-08-06 cfn
| * d911837 2016-08-05 cfn
| * 409e654 2016-07-12 typo
| * 49e8bde 2016-07-01 [TFC-760] add teamcity-build-info script
| * 8d8f2d0 2016-07-01 [TFC-760] typo
| * ba7e7ad 2016-06-21 fix prod-env testing by getting rest-api and build-number from the stack
| * 28724f2 2016-06-19 stop using the slack icon, since it's hidden at times
| * d898544 2016-06-18 [TFC-602] abstract slack-echo
| * a1d14c7 2016-06-18 [TFC-602] update icon default
| * 9623c91 2016-06-18 [TFC-602] usage should be sh_script_usage
| * 007bb82 2016-06-17 [TFC-602] emoji
| * a7951ec 2016-06-17 cleanup duplication in generating CONST-ENV.inc
| * 6d2dbd9 2016-06-15 don't use parse:full or else you cannot format slack urls
| * 27726ca 2016-06-15 stupid underscore vs minus, hyphen, dash
| * dc8c297 2016-06-15 updated support/bin/slack-echo
| * f438416 2016-06-15 fix teamcity url for queued builds
| * 2bf94e0 2016-06-14 add teamcity_url
| * ae84466 2016-06-13 [TFC-602] updated support/bin/aws-get-stack-output
| * e33b458 2016-06-13 [TFC-602] updated support/bin/aws-get-stack-id
| * 8e5023b 2016-06-13 [TFC-602] consistent hyphen
| * 3aa4c58 2016-06-13 [TFC-602] rename
| * 4f7b74c 2016-06-12 [TFC-602] safer naming
| * 1954a17 2016-06-11 [TFC-602] add slack_echo
| * 32b22ee 2016-06-11 [TFC-602] add usage and version
| * a40f8c1 2016-05-28 [TFC-602] fix ignore
* | 6139e49 2017-10-23 extend, not replace SF_CLEAN_FILES
* | d0393ea 2017-10-19 remove ci dependnecy on java/jdk
* | f6eb367 2017-09-22 use support-firecloud only as a git submodule
* | 1236675 2017-09-22 vscode: disable javascript formatter, rely on eslint. see https://github.com/Microsoft/TypeScript/issues/18682
* | 301cefe 2017-09-22 vscode: search uses gitignore
* | 13f0753 2017-09-22 vscode: explicitly format json
* | f4abce0 2017-09-13 add markdown editorconfig rules
* | 5a43db3 2017-09-13 keep specific editorconfig separate
* | 0b5cc85 2017-09-13 shell script files need indent_size 4, not tab_width
* | 2fc31e8 2017-09-05 make sure the cache dir exists
* | 690a90c 2017-09-04 updated repo/core.inc.mk
* | 12060d4 2017-09-01 eclint: more specific path
* | ca13658 2017-09-04 updated repo/core.inc.mk
* | 4053f0e 2017-09-04 install newest bash too
* | 5526ab3 2017-09-04 order
* | e0bc28b 2017-09-04 fix incorrect output flag for curl
* | 53d231a 2017-09-04 add python2 and python3 to vanilla linux ci image
* | decad76 2017-09-04 move installing homebrew to vanilla darwin bootstrap
* | 838aabe 2017-09-04 fix indentation
* | 460c4a9 2017-09-04 simplify
* | f724012 2017-09-04 sudo not needed
* | 692d1f1 2017-09-04 fix indentation
* | d8b71b0 2017-09-04 git needed before common.inc.sh
* | 0e16712 2017-09-04 ci verbosity
* | a1d09e9 2017-09-04 updated repo/core.inc.mk
* | 7c1088a 2017-09-04 update tracks.ini
* | b0c99a5 2017-09-01 fallback_echo even for travis-fold messages
* | 4e8ed67 2017-09-01 disable osx since the waiting time is big
* | 3e8fbae 2017-09-01 add sake executable
* | dd7a84b 2017-09-01 python2
* | a538a38 2017-09-01 fix osx
* | c76afde 2017-08-30 set CI_ECHO
* | 299fea5 2017-08-30 simplify travis scripts
* | a3e9cbc 2017-08-30 disable osx since the waiting time is big
* | 75e7993 2017-08-30 updated README.md
* | c83a83e 2017-08-30 SF_PATH -> SUPPORT_FIRECLOUD_DIR
* | d9be27f 2017-08-30 revamp travis
* | 10d5128 2017-08-30 add new travis setup
* | 04d166b 2017-08-30 add bin utils
* | a3da72e 2017-08-26 non-interactive install is required in ci
* | 3d53512 2017-08-25 add Makefile templates
* | 92586ae 2017-08-25 add core.inc.mk
* | c8c20cd 2017-08-23 order
* | c9fce91 2017-08-23 correct folder change
* | ae81e94 2017-08-23 install jq on linux too
* | d700425 2017-08-22 remove special npmignore editorconfig rule
* | cdb7cc6 2017-08-19 vscode: add sasslint extension
* | 8c804f4 2017-08-17 fix test
* | 8ae5aeb 2017-08-17 integrate with travis ci
* | ff649f1 2017-08-17 moved to github.com/tobiipro
* | f25b93e 2017-08-17 whitespace
* | 1869627 2017-08-17 add html.format to vscode settings
* | bb883d9 2017-08-16 vscode: format on save, tsfmt, recommend extensions
* | 10037c4 2017-08-03 enforce eol in .editorconfig
* | d08c3a7 2017-07-31 use repo settings
* | cb180cb 2017-07-24 updated LICENSE
* | a75f010 2017-07-24 safer eclint check
* | f296c25 2017-07-21 ci
* | e6536d3 2017-07-20 updated .npmignore
* | 288f34d 2017-07-19 npm: add comments
* | d25f1cc 2017-07-19 npm: no package-lock.json
* | 1f5273e 2017-07-18 handle tabs in .gitmodules
* | 7a16b55 2017-07-18 add more global gitignores
* | b7e46c4 2017-07-18 introduce eclint
* | 93029b3 2017-06-16 publish
|/  
* 00256e0 2017-06-16 [empty] initial commit
