...
If you're wondering why we do that, the issues with them include but are not limited to:
...
- simplicity in deciding which strategy to use. See [https://github.com/nodejs/node/blob/913c365db66c7a0d40e72a463da4a2f3147f0c26/COLLABORATOR_GUIDE.md#landing-pull-requests](nodejs) requirements for using the squash merge
