...
LOGNAME = $(call which,LOGNAME,glogname logname)
...
# echo "\$(foreach VAR,$(ls $(brew --prefix coreutils)/libexec/gnubin | grep -v '^\[$' | tr '[:lower:]' '[:upper:]' | tr '\n' ' '),\$(call make-lazy,\$(VAR)))" # editorconfig-checker-disable-line
