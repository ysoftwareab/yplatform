...
$(foreach VAR,AWK BASENAME CAT CHMOD CHOWN COMM CP CUT DIFF FIND ECHO GREP HEAD LS MD5SUM MKDIR MKTEMP MV PARALLEL RM SED SHA256SUM SORT TAR TAIL TEE TOUCH TR WATCH XARGS,$(call make-lazy,$(VAR)))
